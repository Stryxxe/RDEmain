                        ...
                        <div className="max-h-96 overflow-y-auto">
                            ...
                            {conversations.length === 0 && (
                                <>
                                    ...
                                    {availableProponents &&
                                        availableProponents.proponents &&
                                        availableProponents.proponents.length >
                                            0 && (
                                            <div className="p-4 border-b border-gray-200 bg-blue-50">
                                                ...
                                                <div className="space-y-2">
                                                    {availableProponents.proponents.map(
                                                        (proponent) => (
                                                            <div
                                                                key={
                                                                    proponent.userID
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                const newConversation =
                                                                                    updatedResponse.data.data.find(
                                                                                        (
                                                                                            conv
                                                                                        ) =>
                                                                                            String(
                                    ...
                                    <div className="p-6 text-center text-gray-500">
                                        ...
                                        {(!availableProponents ||
                                            ...
                                            availableProponents.proponents
                                                .length === 0) && (
                                            <p className="text-xs text-gray-400 mt-1">
                                                No proponents available in your
                                                department
                                            </p>
                                        )}
                                    </div>
