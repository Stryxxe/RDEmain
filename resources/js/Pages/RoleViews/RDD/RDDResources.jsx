...
import { BiSearch, BiDownload, BiShow, BiFile, BiCalendar, BiUser } from 'react-icons/bi';
...
const RDDResources = () => {
  ...
  const categories = ['All', 'Guidelines', 'Templates', 'Ethics', 'Reference'];
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case 'PDF':
        return <div className="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center"><BiFile className="text-red-600" /></div>;
      case 'DOCX':
        return <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center"><BiFile className="text-blue-600" /></div>;
      case 'XLSX':
        return <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center"><BiFile className="text-green-600" /></div>;
      case 'PPTX':
        return <div className="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center"><BiFile className="text-orange-600" /></div>;
      default:
        return <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center"><BiFile className="text-gray-600" /></div>;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Access guidelines, templates, and reference materials for your research projects
          </p>
        </div>
      </div>
