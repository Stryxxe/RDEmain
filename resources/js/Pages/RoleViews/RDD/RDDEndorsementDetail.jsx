...
const RDDEndorsementDetail = ({ id: proposalId }) => {
    ...
    const getAttachedDocuments = () => {
        ...
        const filtered = fullProposal.files
            .filter((file) => {
                ...
                if (file.fileType === "revision_image") return false;
                return true;
            })
            .map((file) => {
        ...
        try {
            ...
            if (responseData.success) {
                ...
                const proponentName =
                    ...
                    fullProposal.user?.firstName +
                        " " +
                        fullProposal.user?.lastName ||
                    "Unknown";
    ...
    const handleSendForRevision = async () => {
        ...
        try {
            ...
            if (revisionImages.length > 0) {
                updateData.revisionImages = revisionImages.map(
                    (img) => img.file
                );
            }
    ...
    const handleSaveProposal = async (formData) => {
        try {
            ...
            const updateData = {
                researchTitle:
                    formData.researchTitle || fullProposal?.researchTitle,
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-base font-semibold text-amber-900 truncate">
                                            {fullProposal?.status?.statusName ||
                                                "Pending Approval"}
                                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="border-l-4 border-blue-500 pl-6 py-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    fullProposal.researchAgenda.length > 0 ? (
                            ...
                            <div className="border-l-4 border-green-500 pl-6 py-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    fullProposal.dostSPs.length > 0 ? (
                                        ...
                                        <span className="text-gray-500 text-sm">
                                            No DOST strategic programs specified
                                        </span>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="p-8">
                                ...
                                <div className="mb-8">
                                    <label
                                        ...
                                        className="flex items-center text-base font-semibold text-gray-800 mb-3"
                                    >
                                        <svg
