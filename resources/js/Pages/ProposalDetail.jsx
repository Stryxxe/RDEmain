...
const ProposalDetail = () => {
    ...
    const getStatusColor = (statusId) => {
        switch (statusId) {
            case 1:
                return "bg-red-500"; // Under Review
            case 2:
                return "bg-green-500"; // Approved
            case 3:
                return "bg-red-600"; // Rejected
            case 4:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-8 border border-red-100">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
                        ...
                        <div className="flex flex-col items-end gap-3">
                            <span
                                className={`inline-flex px-4 py-2 text-sm font-semibold rounded-xl text-white shadow-lg ${getStatusColor(
                                    proposal.statusID
                                )}`}
                            >
                            ...
                            {matrix.proposedBudget && (
                                <div className="text-right">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">
                                        {formatCurrency(matrix.proposedBudget)}
                                    </p>
                                </div>
                            )}
                            {/* Progress Card */}
                            <div
                                className={`bg-gradient-to-r rounded-2xl p-4 w-full lg:min-w-[240px] xl:min-w-[280px] lg:w-auto flex-shrink-0 transition-colors duration-300 ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-50 rounded-xl p-4">
                        ...
                        <p className="text-lg font-medium text-gray-900">
                            {matrix.researchCenter || "Not specified"}
                        </p>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300 mb-8">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-4">
                            <p className="text-gray-900 whitespace-pre-wrap leading-relaxed">
                                {matrix.description || "Not specified"}
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-4">
                            <p className="text-gray-900 whitespace-pre-wrap leading-relaxed">
                                {matrix.objectives || "Not specified"}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {(matrix.researchAgenda || []).map((agenda, index) => (
                            <span
                                key={index}
                                className="px-3 py-2 bg-blue-100 text-blue-800 rounded-lg text-sm font-medium hover:bg-blue-200 transition-colors duration-200"
                            >
                                {agenda}
                            </span>
                        ))}
                        {(!matrix.researchAgenda ||
                            matrix.researchAgenda.length === 0) && (
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {(matrix.dostSPs || []).map((sp, index) => (
                            <span
                                key={index}
                                className="px-3 py-2 bg-green-100 text-green-800 rounded-lg text-sm font-medium hover:bg-green-200 transition-colors duration-200"
                            >
                                {sp}
                            </span>
                        ))}
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {(matrix.sustainableDevelopmentGoals || []).map(
                            (sdg, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-2 bg-purple-100 text-purple-800 rounded-lg text-sm font-medium hover:bg-purple-200 transition-colors duration-200"
                                >
                                    {sdg}
                                </span>
                            )
                        )}
                        {(!matrix.sustainableDevelopmentGoals ||
                            matrix.sustainableDevelopmentGoals.length ===
                                0) && (
                            <p className="text-gray-500 text-sm">
                                No SDGs specified
                            </p>
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gray-50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        {viewingFile.formattedSize ||
                                            `${Math.round(
                                                viewingFile.fileSize / 1024
                                            )} KB`}
                                    </p>
                                </div>
                            </div>
